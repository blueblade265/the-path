...
const RULE_MAP = {
  ...
  'back-lever':   { type:'TIER', unit:'tier', params:{ subUnit:'sec', tiers:['Not yet achievable — block assist','Not yet achievable — eccentric entry','Tuck','Advanced Tuck','One-Leg','Straddle','Full'] } },
  ...
  'single-leg-balance-left':  { type:'HOLD_TIME', unit:'sec' },
  'single-leg-balance-right': { type:'HOLD_TIME', unit:'sec' },
  ...
  'dragon-flag':  { type:'TIER', unit:'tier', params:{ subUnit:'sec', tiers:['Tuck','Advanced Tuck','Single-Leg','Straddle','Full'] } },
  ...
  'side-lever-left':  { type:'TIER', unit:'tier', params:{ subUnit:'sec', tiers:['Side Plank','Side Plank-Feet Elevated','Tucked','Advanced Tuck','Single-Leg','Straddle','Full'] } },
  'side-lever-right': { type:'TIER', unit:'tier', params:{ subUnit:'sec', tiers:['Side Plank','Side Plank-Feet Elevated','Tucked','Advanced Tuck','Single-Leg','Straddle','Full'] } },
