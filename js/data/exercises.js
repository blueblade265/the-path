...
//
// `category` (push/pull/legs/core/mobility) groups the Program Builder's add-exercise
// picker (js/ui/tab-more.js) — a stable property of the movement pattern itself,
// independent of whatever day a given user actually schedules it on.

import { RULE_MAP } from '../lib/progression-engine.js';

export const EXERCISES = {
  'back-squat': {
    name: 'Back Squat', unit: 'pounds', step: 5, suffix: ' lb', category: 'legs',
  ...
  'deadlift': {
    name: 'Deadlift', unit: 'pounds', step: 5, suffix: ' lb', category: 'pull',
  ...
  'bench-press': {
    name: 'Bench Press', unit: 'pounds', step: 5, suffix: ' lb', category: 'push',
  ...
  'hollow-hold': {
    name: 'Hollow Body Hold', unit: 'seconds held', step: 5, suffix: 's', category: 'core',
  ...
  'pushup-bottom-hold': {
    name: 'Push-Up Bottom Hold', unit: 'seconds held', step: 5, suffix: 's', category: 'push',
  ...
  'ring-support-hold': {
    name: 'Ring Support Hold', unit: 'seconds held', step: 5, suffix: 's', category: 'push',
  ...
  'pike-handstand-hold': {
    name: 'Handstand', unit: 'seconds held', step: 5, suffix: 's', category: 'push',
  ...
  'scapular-pullup': {
    name: 'Scapular Pull-Up', unit: 'clean reps', step: 1, suffix: '', category: 'pull',
  ...
  'skin-the-cat': {
    name: 'Skin the Cat', unit: 'clean reps', step: 1, suffix: '', category: 'pull',
  ...
  'dead-hang': {
    name: 'Dead Hang (rings)', unit: 'seconds held', step: 5, suffix: 's', category: 'pull',
  ...
  'active-hang': {
    name: 'Active Hang (rings)', unit: 'seconds held', step: 5, suffix: 's', category: 'pull',
  ...
  'front-lever': {
    name: 'Front Lever', unit: 'seconds held', step: 1, suffix: 's', category: 'pull',
  ...
  'back-lever': {
    name: 'Back Lever', unit: 'seconds held', step: 1, suffix: 's', category: 'pull',
  ...
  'ring-row': {
    name: 'Ring Row', unit: 'clean reps', step: 1, suffix: '', category: 'pull',
  ...
  'pull-up': {
    name: 'Pull-Up (rings)', unit: 'clean reps', step: 1, suffix: '', category: 'pull',
  ...
  'squat-hold': {
    name: 'Horse Stance', unit: 'seconds held', step: 5, suffix: 's', category: 'legs',
  ...
  'pistol-squat': {
    name: 'Pistol Squat', unit: 'clean reps per side', step: 1, suffix: '', category: 'legs',
  ...
  'single-leg-balance': {
    name: 'Single-Leg Balance', unit: 'seconds, eyes closed', step: 5, suffix: 's', category: 'legs',
  ...
  'single-leg-balance-left': {
    name: 'Single-Leg Balance — Left', unit: 'seconds, eyes closed', step: 5, suffix: 's', category: 'legs',
    coach: 'Left leg. Eyes open to failure first, then eyes closed — log the eyes-closed number.',
    cues: ['Eyes open to failure first, then eyes closed.', 'Soft knee, quiet foot.'],
    abort: 'The lifted foot touches down.'
  },
  'single-leg-balance-right': {
    name: 'Single-Leg Balance — Right', unit: 'seconds, eyes closed', step: 5, suffix: 's', category: 'legs',
  ...
  'nordic-curl': {
    name: 'Nordic Curl', unit: 'clean reps', step: 1, suffix: '', category: 'legs',
  ...
  'calf-raise-hold': {
    name: 'Calf Raise Hold', unit: 'seconds per side', step: 5, suffix: 's', category: 'legs',
  ...
  'l-sit': {
    name: 'L-Sit', unit: 'seconds held', step: 1, suffix: 's', category: 'core',
  ...
  'dragon-flag': {
    name: 'Dragon Flag', unit: 'seconds held', step: 1, suffix: 's', category: 'core',
  ...
  'side-lever': {
    name: 'Side Lever', unit: 'seconds per side', step: 5, suffix: 's', category: 'core',
  ...
  'side-lever-left': {
    name: 'Side Lever — Left', unit: 'seconds held', step: 5, suffix: 's', category: 'core',
    coach: 'Left side. Hold at your current stage. Stop when the hips drop.',
    cues: ['Straight line shoulder to feet, hips lifted.', 'Do not let the body rotate toward the floor.'],
    abort: 'Hips drop, or the body rotates down.'
  },
  'side-lever-right': {
    name: 'Side Lever — Right', unit: 'seconds held', step: 5, suffix: 's', category: 'core',
  ...
  'toes-to-bar': {
    name: 'Toes-to-Bar', unit: 'clean reps', step: 1, suffix: '', category: 'core',
  ...
  'hollow-hold-retest': {
    name: 'Hollow Hold Retest', unit: 'seconds held', step: 5, suffix: 's', category: 'core',
  ...
  'screen-shoulder-flexion': {
    name: 'Shoulder Flexion', unit: 'fist-widths of gap', step: 1, suffix: '', category: 'mobility',
  ...
  'screen-shoulder-rotation': {
    name: 'Shoulder Rotation', unit: 'degrees short', step: 5, suffix: '°', category: 'mobility',
  ...
  'screen-ohs': {
    name: 'Overhead Squat', unit: 'inches of heel lift', step: 1, suffix: '"', category: 'mobility',
  ...
  'screen-couch-stretch': {
    name: 'Couch Stretch', unit: 'note', step: 1, suffix: '', category: 'mobility',
  ...
  'screen-aslr': {
    name: 'Straight Leg Raise', unit: 'degrees short', step: 5, suffix: '°', category: 'mobility',
  ...
  'screen-thoracic-rotation': {
    name: 'Thoracic Rotation', unit: 'degrees short', step: 5, suffix: '°', category: 'mobility',
